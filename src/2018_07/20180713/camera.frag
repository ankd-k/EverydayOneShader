...
void main(){
    ...
    // view matrix
    vec3 v_eye = vec3(cos(t*0.2), -0.8*sin(t*0.267), sin(t*0.2))*2.4;
    v_eye = vec3(0., 0., 0.);
    vec3 v_target = vec3(sin(time*0.1324), sin(time*0.34597), sin(time*0.21459))*0.2;
    v_target = vec3(cos(t*0.2), 0., sin(t*0.3));
